...
void add_radio_button(GtkWidget *vlist, char *pallet);
...
int main(int argc, char *argv[]) {
	...
	add_radio_button(vlist, "Pallet 01");
	add_radio_button(vlist, "Pallet 02");
	add_radio_button(vlist, "Pallet 03");
	add_radio_button(vlist, "Pallet 04");
...
void add_radio_button(GtkWidget *vlist, char *pallet) {
	...
	radio = gtk_radio_button_new_with_label(radio_group, pallet);
